...
:sparkles: Οποιοδήποτε μέλος της ομάδας αντιπετωπίσει τυχόν δυσκολίες ως προς την υλοποίηση των παραδοτέων, πρέπει να αναφερθεί πρώτα στα μέλη της ομάδας και έπειτα στην περιοχή των συζητήσεων του μαθήματος.
